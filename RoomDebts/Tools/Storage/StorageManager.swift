...
public extension StorageManager {
    ...
    public func first<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor], predicate: NSPredicate?) -> Object? {
        return self.first(with: StorageFetchRequest<Object>(sortDescriptors: sortDescriptors, predicate: predicate))
    }
    
    public func first<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor]) -> Object? {
        return self.first(type, sortDescriptors: sortDescriptors, predicate: nil)
    }
    
    public func last<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor], predicate: NSPredicate?) -> Object? {
        return self.last(with: StorageFetchRequest<Object>(sortDescriptors: sortDescriptors, predicate: predicate))
    }
    
    public func last<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor]) -> Object? {
        return self.last(type, sortDescriptors: sortDescriptors, predicate: nil)
    }
    
    public func fetch<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor], predicate: NSPredicate?) -> [Object] {
        return self.fetch(with: StorageFetchRequest<Object>(sortDescriptors: sortDescriptors, predicate: predicate))
    }
    
    public func fetch<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor]) -> [Object] {
        return self.fetch(type, sortDescriptors: sortDescriptors, predicate: nil)
    }
    
    public func count<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor], predicate: NSPredicate?) -> Int {
        return self.count(with: StorageFetchRequest<Object>(sortDescriptors: sortDescriptors, predicate: predicate))
    }
    
    public func count<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor]) -> Int {
        return self.count(type, sortDescriptors: sortDescriptors, predicate: nil)
    }
    
    public func clear<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor], predicate: NSPredicate?) {
        self.clear(with: StorageFetchRequest<Object>(sortDescriptors: sortDescriptors, predicate: predicate))
    }
    
    public func clear<Object: StorageObject>(_ type: Object.Type, sortDescriptors: [NSSortDescriptor]) {
