//
//  DefaultUserAccountsManager.swift
//  RoomDebts
//
...
class DefaultUserAccountsManager<Object>: UserAccountsManager, StorageContextObserver where Object: UserAccount, Object: StorageObject {
    ...
    private(set) lazy var objectsRemovedEvent = Event<[UserAccount]>()
    private(set) lazy var objectsAppendedEvent = Event<[UserAccount]>()
    private(set) lazy var objectsUpdatedEvent = Event<[UserAccount]>()
    private(set) lazy var objectsChangedEvent = Event<[UserAccount]>()
